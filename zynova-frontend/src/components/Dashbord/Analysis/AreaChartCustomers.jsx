    ...
    return (
        ...
        <div className=" w-full h-full bg-white rounded-lg shadow  p-4 md:p-6">
            <div className="flex justify-between">
                ...
                <div
                    className="flex items-center px-2.5 py-0.5 text-base font-semibold text-primary  text-center">
                    12%
                ...
                <div className="flex justify-between items-center pt-5">
                    ...
                    <div id="lastDaysdropdown" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                        <ul className="py-2 text-sm text-gray-700 " aria-labelledby="dropdownDefaultButton">
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-300 ">Yesterday</a>
                            </li>
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-300 ">Today</a>
                            </li>
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-300  ">Last 7 days</a>
                            </li>
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-300  ">Last 30 days</a>
                            </li>
                            <li>
