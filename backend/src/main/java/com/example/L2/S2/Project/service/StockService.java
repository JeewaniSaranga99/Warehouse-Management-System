...
public class StockService {
    ...
    public StockResponse saveStock(Long warehouseId, StockRequest stock) {
        if (stock.getStockId() != null) {
            ...
            Product p = productService.getProductById(stock.getProductId());
            p.setQuantity(p.getQuantity() + stock.getAvailableStock());
    ...
    public Stock updateStock(Long warehouseId, Long stockId, StockRequest stock) {
        ...
        if (existStock.isPresent()) {
            ...
            int diff = stock.getAvailableStock() - existStock.get().getAvailableStock();
            ...
            Product p = productService.getProductById(existStock.get().getProduct().getId());
